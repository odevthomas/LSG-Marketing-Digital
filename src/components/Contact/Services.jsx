        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 64 64">
                    ...
                    <circle cx="49.195" cy="10.225" r=".808" fill="currentColor"/>
                    <circle cx="51.484" cy="12.513" r=".81" fill="currentColor"/>
                    <circle cx="53.771" cy="14.8" r=".81" fill="currentColor"/>
                    <path fill="currentColor" d="M56.634 16.516a.81.81 0 0 0-1.146 0a.81.81 0 0 0 0 1.145a.814.814 0 0 0 1.146 0a.81.81 0 0 0 0-1.145"/>
                </svg>
            ),
        },
        {
