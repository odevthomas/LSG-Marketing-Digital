    ...
    <footer className="bg-black text-white py-8">
      ...
      {isModalOpen && modalContent === 'sobre' && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
          <div className="bg-black p-8 rounded-lg w-4/5 md:w-1/3 overflow-y-auto max-h-[80vh] relative">
            <button 
              onClick={closeModal} 
            ...
            <p className="text-white mb-2">Conecte-se comigo nas redes sociais:</p>
