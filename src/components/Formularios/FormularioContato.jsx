...
const FormularioDeContato = () => {
  ...
  return (
    <section className="flex min-h-screen bg-black justify-center items-center">
      <div className="w-full max-w-lg p-8 bg-black rounded-xl shadow-lg">
        <h4 className="text-2xl font-semibold text-center text-[#f11414]">Entre em Contato Conosco</h4>

        <p className="mt-2 text-white text-center">Nos avise o que podemos fazer por você!</p>

        {submitted ? (
          <div className="text-center mt-6">
            <h2 className="text-lg font-semibold text-[#fff]">Obrigado pelo seu contato!</h2>
            <p className="mt-2 text-gray-800">Em breve um de nossos especialistas responderá via WhatsApp.</p>
          </div>
        ) : (
