  ...
  return (
    ...
    >
      <div className="content relative z-10 text-center px-4 py-1 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        ...
        <p className="text-sm sm:text-base md:text-lg text-black mb-2 font-medium">
          Descubra soluções inovadoras e acessíveis para o seu negócio de beleza e estética.
        </p>

        <p className="text-base sm:text-lg md:text-xl text-black mb-3 font-semibold">
          <span className="text-sm sm:text-base md:text-lg ml-2">A partir de </span>
          <span className="price-highlight text-2xl sm:text-3xl md:text-4xl font-semibold text-[#fb1603]">
            R$ 599/mês
          </span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center mt-4 gap-3">
          <a
            ...
            className="inline-flex items-center justify-center border-1 border-[#f11414] text-white py-2 px-5 text-base transition duration-300 w-full sm:w-auto hover:bg-[#b23012] shadow-lg transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#f11414] focus:ring-opacity-50 text-center rounded-full bg-[#f11414]"
