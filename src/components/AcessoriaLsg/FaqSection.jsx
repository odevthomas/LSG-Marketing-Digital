...
const FaqSection = () => {
  ...
  return (
    <section className="bg-black py-16 z-10">
      <div className="container mx-auto px-6 text-white z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-gray-700 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105">
            <button
              className="flex items-center justify-between w-full p-6 text-left transition-colors duration-300 ease-in-out hover:bg-gray-800 rounded-lg"
            ...
            {expanded === 0 && (
              <>
                ...
                <p className="p-6 text-base text-gray-200">
          ...
          <div className="border border-gray-700 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105">
            ...
            >
              <h2 className="font-semibold text-lg text-gray-200">
                Como posso aumentar minha presença digital com a sua agência?
              </h2>
              <span className="text-gray-400 bg-[#000001] rounded-full p-2 transition-colors duration-300 hover:bg-[#000001]">
                {expanded === 5 ? (
                  <Minus className="w-6 h-6 text-[#f4f4f4]" />
            ...
            {expanded === 5 && (
              <>
                <hr className="border-t-2 border-blue-900" />
                <p className="p-6 text-base text-gray-200">
                  Nossa agência oferece estratégias avançadas de SEO, campanhas de mídia paga, e gestão de redes sociais para garantir que sua marca seja vista e reconhecida online, ajudando a alcançar novos clientes e consolidar sua presença digital.
                </p>
              </>
            )}
          </div>
