...
const WhatsAppButton = () => {
  ...
  return (
    <FloatingWhatsApp
      ...
      chatMessage="Olá, como podemos ajudar?" // Mensagem inicial no chat
      ...
      buttonImage="/img/AVATAR.BOT.jpeg" // Caminho da imagem personalizada do botão
      buttonStyle={{
      ...
      chatboxStyle={{
        ...
        backgroundColor: "#1c1c1c", // Cor de fundo escura no chatbox
      ...
      onClose={handleClose} // Callback para quando a caixa de bate-papo for fechada
      onNotificationClick={handleNotification} // Callback para quando a notificação for clicada
    />
  );
};
