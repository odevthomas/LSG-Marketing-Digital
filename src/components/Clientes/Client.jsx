...
const ImageCarousel = () => {
    ...
    return (
        <section className="py-14" style={{ backgroundColor: '#010101' }}>
            <div className="max-w-screen-xl mx-auto md:px-8">
                <div className="flex flex-col lg:flex-row items-center gap-x-12 sm:px-4 md:px-0">
                    ...
                    <div className="max-w-xl px-4 space-y-5 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                        <motion.h3 
                            className="text-[#010101] font-semibold mb-4 text-lg sm:text-xl"
                      ...
                      <motion.p 
                                className="text-white text-3xl sm:text-4xl md:text-5xl font-semibold mb-4 text-center"
                                initial={{ opacity: 0, y: -10 }}
                                animate={{ opacity: 1, y: 0 }}
